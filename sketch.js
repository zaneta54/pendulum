...
function draw() {
  ...
  text("Press space bar to move the pendulum to move left and right with mouse",10,20);
  text("Press Enter to stop the Pendulum from moving",100,50);

  fill ("pink");
rectMode(CENTER);
rect(holder.position.x,holder.position.y,300,10);
